 ...
 * the provider/consumer boilerplate every SDK context would otherwise repeat:
 * declare the value type, name the context for error messages, and read it with
 * `use()` (required) or `useMaybe()` (optional).
 */
