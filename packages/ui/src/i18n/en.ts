...
export const enUiMessages: Record<string, string> = {
  ...
  "modal.cancel": "Cancel",
  "modal.done": "Done",
  "theme.customization.description": "Start from this theme and change only the design choices you want. Both light and dark schemes are regenerated together.",
  "theme.customization.themeDefault": "Theme default",
  "theme.customization.section.identity": "Identity palette",
  "theme.customization.section.surfaces": "Surfaces and navigation",
  "theme.customization.section.feedback": "Status palette",
  "theme.customization.section.form": "Type, shape and mark",
  "theme.customization.brand": "Brand color",
  "theme.customization.accent": "Accent color",
  "theme.customization.neutral": "Neutral tint",
  "theme.customization.canvas": "Page background",
  "theme.customization.surface": "Cards and panels",
  "theme.customization.rail": "App rail",
  "theme.customization.success": "Success",
  "theme.customization.warning": "Warning",
  "theme.customization.danger": "Danger",
  "theme.customization.info": "Information",
  "theme.customization.font": "Typography",
  "theme.customization.radius": "Corners",
  "theme.customization.density": "Control density",
  "theme.customization.elevation": "Elevation",
  "theme.customization.logo": "Logo mark",
  "theme.customization.restore": "Restore theme defaults",
  "theme.customization.font.system": "System sans",
  "theme.customization.font.inter": "Inter",
  "theme.customization.font.humanist": "Humanist sans",
  "theme.customization.font.industrial": "Industrial sans",
  "theme.customization.font.editorial": "Editorial serif",
  "theme.customization.font.mono": "Monospace",
  "theme.customization.radius.square": "Square",
  "theme.customization.radius.compact": "Compact",
  "theme.customization.radius.standard": "Standard",
  "theme.customization.radius.soft": "Soft",
  "theme.customization.radius.round": "Round",
  "theme.customization.density.compact": "Compact",
  "theme.customization.density.balanced": "Balanced",
  "theme.customization.density.comfortable": "Comfortable",
  "theme.customization.density.spacious": "Spacious",
  "theme.customization.elevation.flat": "Flat",
  "theme.customization.elevation.subtle": "Subtle",
  "theme.customization.elevation.soft": "Soft",
  "theme.customization.elevation.dramatic": "Dramatic",
  "theme.customization.logo.brand": "Brand palette",
  "theme.customization.logo.accent": "Accent palette",
  "theme.customization.logo.mono": "Monochrome",
  "theme.customization.logo.star": "Star geometry",
  "theme.customization.logo.corner": "Corner geometry",
  "dialog.close": "Close",
  ...
  "resourceToolbar.clearQuery": "Clear filters, sorting and grouping",
  ...
  "resourceToolbar.advancedGranularity": "More",
  "resourceToolbar.basicGranularity": "Less",
  ...
  "resourceToolbar.boardView": "Board view",
    ...
    "resourceToolbar.dashboardView": "Dashboard view",
  ...
  "chatter.tabRecords": "Records",
  "chatter.recordTrail": "Related records",
  "chatter.previousRecord": "Back {number}",
  "chatter.openRecord": "Open full record",
  ...
  "form.value.set": "Set value",
  "form.value.leaveEmpty": "Leave empty",
  "form.value.optional": "Optional",
  "form.value.omit": "Omit value",
  "form.list.add": "Add item",
  "form.list.remove": "Remove",
  "form.list.moveUp": "Move up",
  "form.list.moveDown": "Move down",
  "form.list.item": "Item {number}",
  "form.list.removeNamed": "Remove item {number}",
  "form.list.actionNamed": "{action} {number}",
  ...
  "lines.section": "Lines",
  "lines.showDetails": "Show line details",
  "lines.hideDetails": "Hide line details",
  "select.label": "Select",
