...
Encode no repo-specific facts. Read `https://docs.angee.ai/react/guidelines`, `docs/stack.md`
...
## Read first
- `https://docs.angee.ai/react/guidelines` — the frontend rules (SDK-vs-rendered split, "TS
