...
- ⏳ **CODEX IN-FLIGHT** — FormView chrome part 1: unsaved-changes **nav guard** (TanStack Router `useBlocker` + confirm) + **inline editable title** + a FormView story. (Smart-buttons / More menu / notebook tabs deferred — need record-relation data.)
