...
def test_record_access_mutations_are_atomic_and_delegate_subject_policy() -> None:
    ...
    fields = {field.python_name: field for field in RecordAccessMutation.__strawberry_definition__.fields}
    ...
    with actor_context(owner):
        ...
        assert revoke(object(), info, "projects/project", [first.sqid], "reader", str(stale)).ok
