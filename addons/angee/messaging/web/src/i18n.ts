...
export const enMessagingMessages: Record<string, string> = {
  ...
  "channel.pairing.starting": "Starting the pairing session…",
  ...
  "channel.pairing.loggedOut": "This account unlinked the session.",
  "channel.pairing.paused": "This channel connection is paused.",
