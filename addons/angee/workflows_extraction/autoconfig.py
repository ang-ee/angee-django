...
SETTINGS = {
    ...
    # Historical workflows_ocr migrations deserialize their original field.
    # Active extraction code reads only the canonical setting above.
    ...
    "ANGEE_EXTRACTION_APPROVED_MODEL_DEPLOYMENTS": None,
}
