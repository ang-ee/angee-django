"""GraphQL resources for queues/stages and the composed task work columns."""
...
from angee.projects.schema import TaskType
...
_RESOURCE_TYPES = [*_QUEUE_RESOURCE.types, *_STAGE_RESOURCE.types]

_WORK_SCHEMA_BUCKET = {
    "query": [_QUEUE_RESOURCE.query, _STAGE_RESOURCE.query],
    "mutation": [_QUEUE_RESOURCE.mutation, _STAGE_RESOURCE.mutation],
    "types": [WorkQueueType, WorkStageType, TaskType, *_RESOURCE_TYPES],
