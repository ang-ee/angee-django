...
| httpx | HTTP client/transport for the authlib OAuth2 client and the OAuth/OIDC discovery + userinfo GETs | The honest `Angee-Integrate/1.0` User-Agent and a per-row session; an injected transport is the test seam |
