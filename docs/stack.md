...
| pypdfium2 + Pillow | Bounded PDF rasterization and image normalization | `workflows_ocr` turns authorized stored PDFs/images into ordered, capped JPEG page inputs before dispatching to a registry-selected OCR engine |
