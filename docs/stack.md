...
| Ajv 8 (Draft 2020-12) + ajv-formats 3 | Full browser JSON Schema branch and format validation | Shared FormSpec binds the frozen native Decision schema to action-specific input projection and registers only supported presentation metadata keywords; no coercion, default insertion, or field removal |
