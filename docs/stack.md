...
| jsonschema | JSON Schema validation | `workflows_extraction` validates each declared extraction schema and the merged evidence result with the Draft 2020-12 validator |
