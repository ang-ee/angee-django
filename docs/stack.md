...
| pytest + pytest-django | Backend tests, native test-database setup and transactional flush | Synthetic projects and addon-owned [`workflows`](../addons/angee/workflows/testing/__init__.py) / [`integrate`](../addons/angee/integrate/testing/__init__.py) test compositions; generic [`composed_tables`](../angee/testing/fixtures.py) permission synchronization |
