...
| django-countries >= 9 | ISO 3166-1 alpha-2 country codes and translated display names | Country-code model fields retain their string storage/API shape and expose the upstream choices through resource metadata |
