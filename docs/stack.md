...
| django-zed-rebac >= 0.16.2 | REBAC engine, Zed introspection/rendering/extension, identity storage attributes and lazy SQL permission scoping/projection/combination | Addon schema composition, reserved roles and actor resolution through public REBAC APIs |
